  ...
  return (
    <input
      className={cn(
        ...
        isDateInput &&
          'h-12 rounded-md border-[#3a344b] bg-[#0b0a14] px-4 font-mono text-base font-semibold text-[#f7f3ff] shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_10px_28px_rgba(0,0,0,0.22)] hover:border-[#5b536d] focus:border-[#9ef7ee] focus:bg-[#0e0d18] focus:ring-[#00f5d4]/20',
        className,
      )}
      {...props}
    />
